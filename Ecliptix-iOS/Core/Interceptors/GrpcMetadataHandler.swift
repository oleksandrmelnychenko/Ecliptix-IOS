...
public class GrpcMetadataHandler {
    ...
    public static func generateMetadata(appInstanceId: String, appDeviceId: String, operationId: UUID = UUID.init()) -> HPACKHeaders {
        ...
        headers.add(name: Self.applicationInstanceIdKey, value: appInstanceId)
        headers.add(name: Self.appDeviceId, value: appDeviceId)
